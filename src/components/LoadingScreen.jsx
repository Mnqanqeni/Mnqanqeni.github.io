...
export default function LoadingScreen(onComplete) {
    ...
    return (
        ...
        <h1 className=" text-4xl font-mono font-bold min-w-[12ch] min-h-[1em]"><span ref={el}> | </span></h1>
        <div className="w-[255px] h-[3px] bg-fourth rounded relative overflow-hidden">
