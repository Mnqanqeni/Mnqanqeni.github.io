...
//   return (
//     <div className="fixed inset-0 flex flex-col items-center justify-center h-full px-4 bg-gradient-to-br from-cyan-500/60 via-primary to-transparent text-fourth">
