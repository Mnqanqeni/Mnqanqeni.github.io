...
function Skills() {
  return (
    <section id="skills" className="flex flex-col items-center scroll-mt-14">
      <h1 className="text-3xl font-bold mt-12 xl:text-5xl"> <span className="text-secondary">My </span>Skills</h1>
